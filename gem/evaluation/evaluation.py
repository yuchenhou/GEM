...
def evaluate(model_dir, training_file, testing_file, dimension):
    training_set = learn.datasets.base.load_csv_without_header(training_file, numpy.float64, numpy.float64)
    testing_set = learn.datasets.base.load_csv_without_header(testing_file, numpy.float64, numpy.float64)
